 ...
 */
class m180704_101249_create_shop_tag_assignments_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function up()
    {
        ...
        $this->addForeignKey('{{%fk-shop_tag_assignments-product_id}}', '{{%shop_tag_assignments}}', 'product_id', '{{%shop_product}}', 'id', 'CASCADE', 'RESTRICT');
        $this->addForeignKey('{{%fk-shop_tag_assignments-tag_id}}', '{{%shop_tag_assignments}}', 'tag_id', '{{%shop_tag}}', 'id', 'CASCADE', 'RESTRICT');
    }
