...
<div class="row">
    <div class="col-md-2 col-sm-6 hidden-xs">
        <div class="btn-group btn-group-sm">
            <button type="button" id="list-view" class="btn btn-default" data-toggle="tooltip" title="List"><img src="http://static.sh.com/cache/manufacturers/list.png" alt="list"</button>
            <button type="button" id="grid-view" class="btn btn-default" data-toggle="tooltip" title="Grid"><img src="http://static.sh.com/cache/manufacturers/grid.png" alt="grid"></img></button>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=30"><img src="http://static.sh.com/cache/products/canon_eos_5d_1-228x228.jpg" alt="Canon EOS 5D" title="Canon EOS 5D" class="img-responsive" /></a></div>
            <div>
                <div class="caption">
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=47"><img src="http://static.sh.com/cache/products/hp_1-228x228.jpg" alt="HP LP3065" title="HP LP3065" class="img-responsive" /></a></div>
            <div>
                <div class="caption">
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=28"><img src="http://static.sh.com/cache/products/htc_touch_hd_1-228x228.jpg" alt="HTC Touch HD" title="HTC Touch HD" class="img-responsive" /></a></div>
            <div>
                <div class="caption">
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=40"><img src="http://static.sh.com/cache/products/iphone_1-228x228.jpg" alt="iPhone" title="iPhone" class="img-responsive" /></a></div>
            <div>
                <div class="caption">
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=48"><img src="http://static.sh.com/cache/products/ipod_classic_1-228x228.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive" /></a></div>
            <div>
                <div class="caption">
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=43"><img src="http://static.sh.com/cache/products/macbook_1-228x228.jpg" alt="MacBook" title="MacBook" class="img-responsive" /></a></div>
            <div>
                <div class="caption">
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=44"><img src="http://static.sh.com/cache/products/macbook_air_1-228x228.jpg" alt="MacBook Air" title="MacBook Air" class="img-responsive" /></a></div>
            <div>
                <div class="caption">
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=29"><img src="http://static.sh.com/cache/products/palm_treo_pro_1-228x228.jpg" alt="Palm Treo Pro" title="Palm Treo Pro" class="img-responsive" /></a></div>
            <div>
                <div class="caption">
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=33"><img src="http://static.sh.com/cache/products/samsung_syncmaster_941bw-228x228.jpg" alt="Samsung SyncMaster 941BW" title="Samsung SyncMaster 941BW" class="img-responsive" /></a></div>
            <div>
                <div class="caption">
    ...
    <div class="product-layout product-list col-xs-12">
        <div class="product-thumb">
            <div class="image"><a href="/index.php?route=product/product&amp;path=20&amp;product_id=46"><img src="http://static.sh.com/cache/products/sony_vaio_1-228x228.jpg" alt="Sony VAIO" title="Sony VAIO" class="img-responsive" /></a></div>
            <div>
                <div class="caption">
