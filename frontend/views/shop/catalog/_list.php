...
<div class="row">
    <div class="col-md-2 col-sm-6 hidden-xs">
        <div class="btn-group btn-group-sm">
            <button type="button" id="list-view" class="btn btn-default" data-toggle="tooltip" title="List"><img src="http://static.sh.com\cache\manufacturers\list.png"></button>
            <button type="button" id="grid-view" class="btn btn-default" data-toggle="tooltip" title="Grid"><img src="http://static.sh.com\cache\manufacturers\grid.png"></button>
        </div>
    </div>
