    ...
    <div class="product-thumb">
        ...
        <div>
            ...
            <div class="button-group">
                ...
                <button type="button" data-toggle="tooltip" title="Compare this Product" href="<?= Url::to(['/shop/cart/add', 'id' => $product->id]) ?>" data-method="post"><img src="http://static.sh.com/cache/manufacturers/Compare.png"></button>
            </div>
        </div>
    </div>
</div>
