    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-default">
                ...
                <div class="box-body">
                    <?= $form->field($model->categories, 'main')->dropDownList($model->categories->categoryList(), ['prompt' => '']) ?>
                    <?= $form->field($model->categories, 'others')->checkboxList($model->categories->categoryList()) ?>
                </div>
            </div>
        </div>
        <div class="col-md-6">
