                    ...
                    <td class="text-left">
                        ...
                        <div class="input-group btn-block" style="max-width: 200px;">
                            ...
                            <span class="input-group-btn">
                                    <button type="submit" title="" class="btn btn-primary" data-original-title="Update"><img src="http://static.sh.com/cache/manufacturers/refresh.png"></button>
                                    <a title="Remove" class="btn btn-danger" href="<?= Url::to(['remove', 'id' => $item->getId()]) ?>" data-method="post"><img src="http://static.sh.com/cache/manufacturers/delete.png"></a>
                                </span>
                        </div>
                        <?= Html::endForm() ?>
                    </td>
